...
@dataclass
class Session(ABC):
    """Virtual base class for a session, which represents a single client connection. This will be used to manage the state of the connection and route messages to the correct app instance."""

    _connector = SessionConnector()
